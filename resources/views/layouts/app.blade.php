<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" ng-app="angularTable">
<head>
    <meta charset="utf-8">
    ...
    <title>{{ config('app.name', 'Hoang1') }}</title>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                ...
                @else
                    <a class="navbar-brand" href="{{ isset(Auth::user()->name) ? url('/home') : url('/admin/home') }}">
                        {{ config('app.name') }}
                    </a>
                @endguest
